...
pipeline {
    ...
    post {
        always {
            ...
            sh """curl -X POST -d '{"feature-estadomundial","develop"}' -H "Accept 'application/vnd.github.v3+json'" -H "Authorization token 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" https://api.github.com/repos/jesusdonoso/ms-iclab/pulls"""
        }
        success {
